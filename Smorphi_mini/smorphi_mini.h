...
#ifndef Smorphi_mini_H_
#define Smorphi_mini_H_
...
public:
  ...
  double sm_PWM_M1FR = 0.0, sm_PWM_M1FL = 0.0, sm_PWM_M1RR = 0.0, sm_PWM_M1RL = 0.0, sm_PWM_M2FR = 0.0, sm_PWM_M2FL = 0.0, sm_PWM_M2RR = 0.0, sm_PWM_M2RL = 0.0;

  //Each wheel velocity in m/s
  double sm_lv_M1FR = 0.0, sm_lv_M1FL = 0.0, sm_lv_M1RR = 0.0, sm_lv_M1RL = 0.0, sm_lv_M2FR = 0.0, sm_lv_M2FL = 0.0, sm_lv_M2RR = 0.0, sm_lv_M2RL = 0.0;
  ...
  // Helper Functions
  char sm_getShape();
  void SetSmorphi_miniSpeed(double pwm[2][4]);
